package com.mt.agent.workflow.api.ai.model;

import com.mt.agent.workflow.api.ai.enums.AliModelType;
import com.mt.agent.workflow.api.ai.enums.ModelCapability;
...
public class RequestConfig {
     ...
     */
    @Builder.Default
    private AliModelType aliModelType = AliModelType.getDefaultModel();
     ...
     * @return 思考模式配置对象
     */
    public static RequestConfig thinkingConfig() {
        return RequestConfig.builder()
                .aliModelType(AliModelType.getModelWithCapability(ModelCapability.SUPPORTS_THINKING))
                .enableThinking(true)
     ...
     * @return 流式输出配置对象
     */
    public static RequestConfig streamingConfig() {
        return RequestConfig.builder()
     ...
     * @return 创造性配置对象
     */
    public static RequestConfig creativeConfig() {
        return RequestConfig.builder()
                .temperature(0.8f)
                .topP(0.95)
                .build();
